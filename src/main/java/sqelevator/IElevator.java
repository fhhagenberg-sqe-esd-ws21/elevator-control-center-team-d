 ...
 * <ul>
 * <li>Elevator capacity. The maximum number of passengers that can fit on an 
 * elevator.</li>
 * <li>Elevator speed. The maximum speed an elevator can travel at in feet/sec. 
 * It is assumed to be the same for all elevators.</li>
 * <li>Elevator acceleration. The rate at which the elevator can increase or decrease
 ...
 * <li>Number of floors. The number of floors in the building, including the ground floor. It is
 ...
 * at 0 for floor 1.</li> 
 * <li>Floor height. The height of the floors in feet. It is assumed that each floor is 
 * the same height.</li>
 * <li>Number of elevators. The number of elevators in the building. Elevator numbering starts 
 * at zero for elevator 1.</li>
 * </ul>
 * 
 * <p>Some elevator behavior is inherent and cannot be controlled:
 * <ul>
 * <li>Door opening &amp; closing. Elevator doors automatically open when arriving at a floor and 
 ...
 * <li>Elevator buttons. Arriving passengers press the appropriate elevator button and the 
 * light is automatically turned off when the elevator arrives at the associated floor.</li>
 * <li>Elevator speed and acceleration. The elevator will automatically accelerate to the maximum 
 ...
 * <ul>
 * <li>Elevator speed. The current speed of the elevator. Positive speed indicates an elevator
 * heading up while negative indicates an elevator going down.</li>
 * <li>Elevator acceleration. The acceleration of the elevators.</li>
 * <li>Elevator button status. For each elevator, which floor buttons on the elevator have 
 * been pressed.</li>
 * <li>Elevator position. The current position of the elevator, both in feet and to 
 * the closest floor. Position is measured in feet above ground floor with zero being the bottom.</li>
 * <li>Elevator door status. Whether the doors for an elevator are open or closed. The 
 * status may also indicate a transition between open or closed.</li>
 * <li>Elevator target. The current floor target of the elevator as set by the controller. The
 * elevator will travel to that target and stop until directed to the next target.</li>
 * <li>Elevator committed direction. The current committed direction of the elevator. Elevators
 ...
 * <li>Elevator floor service. Whether a particular elevator services a particular floor. When 
 ...
 * <li>Elevator weight. This provides the current weight of the elevator less the weight of the 
 ...
 * <ul>
 * <li>Elevator target. Sets the floor target of a particular elevator. Typically, this target 
 ...
 * next target.</li>
 * <li>Elevator committed direction. Sets the current committed direction of the elevator. This 
 ...
 * <li>Elevator floor service. Sets whether a particular elevator services a particular floor. 
...
public interface IElevator extends java.rmi.Remote {
	 ...
	 * @throws java.rmi.RemoteException when shit fails
	 */
